...
if __name__ == "__main__":
    ...
    model_path = f"svhn_{m}_{b}.h5"

    # Load Data
    train_ds, test_ds = tfds.load("svhn_cropped", split=["train", "test"], shuffle_files=False, as_supervised=True)
    ...
    cnn.add(larq.layers.QuantConv2D(filters=64, kernel_size=(3,3), pad_values=1, padding="same"))
